...
const VerifyCertificate = () => {
  ...
  const verify = async (id) => {
    ...
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL || '/api'}/certificates/verify/${trimmed}`);
      setCertificate(data);
    } catch (err) {
  ...
  const handleDownload = () => {
    ...
    link.href = `${import.meta.env.VITE_API_URL || '/api'}/certificates/public/${certificate.certificateId}/download`;
